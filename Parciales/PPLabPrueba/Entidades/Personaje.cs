...
namespace Entidades
{
    public abstract class Personaje
    {
        ...
        private Personaje() // Constructor privado que instancia la lista de habilidades
        {
        ...
        #region Metodos
        /// <summary>
        /// Retorna toda la informacion del personaje
        /// </summary>
        /// <returns></returns>
        public virtual string InfoPersonajes()
        {
