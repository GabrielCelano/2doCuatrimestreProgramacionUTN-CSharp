...
namespace VistaConsola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Posicion.Delantero);
            Jugador j7 = new Jugador("Martín", "Perez", 26, 36555443, 66.5f, 1.73f, Posicion.Defensor); Jugador j8 = new Jugador("Diego", "Roa", 25, 37456678, 86.5f, 1.94f, Posicion.Delantero);
