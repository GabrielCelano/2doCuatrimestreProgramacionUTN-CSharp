...
namespace FrmPrincipal
{
    public partial class FormularioPrincipal : Form
    {
        ...
        {
            rtbPersonajes.Text = Marvel.MostrarInformacion();//Agrego la lista de personajes al RichTextBox
            if (ReferenceEquals(rtbPersonajes.Text, ""))//Verifico si la lista esta vacia o no
            {
                MessageBox.Show("No se agrego ningun superheroe o enemigo en la lista!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);//Si no se agrego nada a la lista, muestro el MessageBox
            }
        }
    }
}
