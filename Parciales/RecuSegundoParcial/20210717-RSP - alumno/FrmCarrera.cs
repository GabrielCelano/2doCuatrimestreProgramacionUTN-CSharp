...
namespace _20210717_RSP___alumno
{
    ...
    public partial class FrmCarrera : Form
    {
        ...
        private void FrmCarrera_Shown(object sender, EventArgs e)
        {
            ...
            this.thread = new Thread(carrera.IniciarCarrera);
            this.thread.Start();
        }
        ...
        private void AvanzarAuto()
        {
            ...
            {
                InformacionDeAvance informarAvanceDelegado = new InformacionDeAvance(this.AvanzarAuto);
                this.Invoke(informarAvanceDelegado);
            }
            else
            {
        ...
        private void ImprimirMensaje(string mensaje)
        {
            ...
            if (this.InvokeRequired)
            {
                InformacionLlegada informarLlegadaDelegado = new InformacionLlegada(this.ImprimirMensaje);
                this.Invoke(informarLlegadaDelegado, new object[] { mensaje });
            }
            else
            {
        ...
        private void FrmCarrera_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            GestorDeArchivos gestorDeArchivos = new GestorDeArchivos("SerializarAutos.xml");
            gestorDeArchivos.Guardar(this.carrera);
        }
    }
}
